...
*/
(function(){
  let $pop_mask = $('.pop-mask');
  let $edit_pop = $(".edit-pop");
  /**
   * 图形库
   */
  let shapeMap = {
    ...
    "rhombus":"<svg width='100' height='50' version='1.1'><polygon points='0,25 50,0 100,25 50,50' style='fill:#fff;stroke:#000000;stroke-width:1'></polygon></svg>",
    "rhomboid":"<svg width='100' height='50' version='1.1'><polygon points='20,1 100,1 80,49 0,49' style='fill:#fff;stroke:#000000;stroke-width:1'></polygon></svg>",
    "right_trapezoid":"<svg width='100' height='50' version='1.1'><polygon points='10,20 90,1 90,49 10,49' style='fill:#fff;stroke:#000000;stroke-width:1'></polygon></svg>",
  ...
  jsPlumb.ready(function () {
     ...
     */
    let checkTemplate = function(shapeId,shapeTemplate,shapeText){
      let commonFirstPart = "<div id=" + shapeId + " class='shape' data-shape= " + shapeTemplate + ">" +
     ...
     */
    let createShapes = function(shapes){
      let shape_id,
        shape_style,
        shape_template,
        shape_text;
     ...
     */
    let createConnections = function(connections){
      // console.log(instance);
      let sourceId,targetId,sourceUUID,targetUUID,labelText;
     ...
     */
    let initGenerate = function (info) {
      let conns = info.conns_info;
      let shapes = info.shapes_info;
      if(shapes) createShapes(shapes);
      if(conns) createConnections(conns);
    };
    ...
    $('button.flowchart-save-button').click(function () {
      ...
      //连接信息
      let conns_info = [];
      let connList = instance.getAllConnections();
